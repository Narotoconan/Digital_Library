...
<div id="bookAdd" class="w-50">
    ...
    <el-form :label-position="labelPosition" label-width="80px" :model="bookUpMessage" id="bookUpMg">
        <el-form-item label="上传封面">
            <div class="position-relative" id="bav" style="height: 10rem;width: 10rem;background-color: #f2f2f2;border: 1px solid">
                <img :src="'../'+bookUpMessage.bookCover" alt="" id="bavImg" style="width: 100%;height: 100%;border-radius: 10px;border: 1px solid #eaeaea;">
        ...
        <el-form-item label="图书资源">
            ...
            <label class="custom-file-label" for="bookResource">{{bookUpMessage.bookDownload}}</label>
        </el-form-item>
        <el-form-item label="书名">
            <el-input v-model="bookUpMessage.bookName" name="bookName"></el-input>
        </el-form-item>
        <el-form-item label="作者">
            <el-input v-model="bookUpMessage.bookAuthor" name="bookAuthor"></el-input>
        </el-form-item>
        <el-form-item label="类别">
            <el-select v-model="bookUpMessage.bookCategory" placeholder="请选择" name="bookCategory">
                <el-option
        ...
        <el-form-item label="出版社">
            <el-input v-model="bookUpMessage.bookPress" name="bookPress"></el-input>
        </el-form-item>
